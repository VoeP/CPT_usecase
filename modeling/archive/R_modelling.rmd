...
SET_SEED <- 42
size_tune <- 20 # number of hyperparameter combinations to try per model
...
- We were interested on which features were better at predicting the target variable.
...
- We checked whether our model gets the whole series can this be an updated research question
...
- There is a correlation between class support (number of samples) and these metrics.
...
```{r full_cpt_evaluation, results='asis'}
